...
async function startApp() {
  ...
  if (isFirstBoot) {
    handleProgress(90, "Finalizing environment configuration...");
  ...
  handleProgress(92, "Loading dashboard interface...");
  await mainWindow.loadURL(paths.mainDashboardUrl);
  handleProgress(98, "Preparing interface...");
